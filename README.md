...
Folder "Code" contains R code for data wrangling and analysis

Folder "Results" contains the plots of the papers plus additional visual for model convergence checking
